...
public class BinaryTree_Editted<E> {
	private BinaryTree_Editted<E> left, right;	// children; can be null
	E data;

	/**
	 * Constructs leaf node -- left and right are null
	 */
	public BinaryTree_Editted(E data) {
	 ...
	 */
	public BinaryTree_Editted(E data, BinaryTree_Editted<E> left, BinaryTree_Editted<E> right) {
	...
	public BinaryTree_Editted<E> getLeft() {
		return left;
	}

	public BinaryTree_Editted<E> getRight() {
		return right;
	}
	 ...
	 */
	public boolean equalsTree(BinaryTree_Editted<E> t2) {
	 ...
	 */
	public static BinaryTree_Editted<String> parseNewick(String s) {
		BinaryTree_Editted<String> t = parseNewick(new StringTokenizer(s, "(,)", true));
	 ...
	 */
	public static BinaryTree_Editted<String> parseNewick(StringTokenizer st) {
		String token = st.nextToken();
		if (token.equals("(")) {
			// Inner node
			BinaryTree_Editted<String> left = parseNewick(st);
			String comma = st.nextToken();
			BinaryTree_Editted<String> right = parseNewick(st);
			String close = st.nextToken();
			String label = st.nextToken();
			String[] pieces = label.split(":");
			return new BinaryTree_Editted<String>(pieces[0], left, right);
		}
		else {
			// Leaf
			String[] pieces = token.split(":");
			return new BinaryTree_Editted<String>(pieces[0]);
		}
	}
	...
	public BinaryTree_Editted<E> copyToDepth(int d){
		BinaryTree_Editted<E> lef = null;
		BinaryTree_Editted<E> righ = null;
//		BinaryTree_Editted res =
		E mydata = this.data;

		if (d == 0) return new BinaryTree_Editted<E>(mydata);

		else{
			if (hasLeft()){
				lef = left.copyToDepth(d - 1);
			}
			if (hasRight()){
				righ = right.copyToDepth(d - 1);
			}
		}
		return new BinaryTree_Editted<E>(mydata, lef, righ);
	}
	...
	public static void main(String[] args) throws IOException {
		...
		BinaryTree_Editted<String> root = new BinaryTree_Editted<String>("G");
		root.left = new BinaryTree_Editted<String>("B");
		root.right = new BinaryTree_Editted<String>("F");
		BinaryTree_Editted<String> temp = root.left;
		temp.left = new BinaryTree_Editted<String>("A");
		temp.right = new BinaryTree_Editted<String>("C");
		temp = root.right;
		temp.left = new BinaryTree_Editted<String>("D");
		temp.right = new BinaryTree_Editted<String>("E");
...
//		BinaryTree_Editted<String> t = new BinaryTree_Editted<String>("A");
//		System.out.println(t.height());
//		System.out.println(t.size());
//
//		// Smaller trees
//		BinaryTree_Editted<String> t1 = parseNewick("((a,b)c,(d,f)e)g;");
...
//		t1.traverse();
		...
		//
		BinaryTree_Editted<String> bin = root.copyToDepth(2);
		System.out.println(bin);
		

//		BinaryTree_Editted<String> t2 = parseNewick("((a,b)c,(d,e)f)g;");
//		BinaryTree_Editted<String> t3 = parseNewick("((a,b)z,(d,e)f)g;");
//		System.out.println("== " + t1.equalsTree(t2) + " " + t1.equalsTree(t3));
//
//		// Tournament
//		BinaryTree_Editted<String> tournament = parseNewick("(((b,c1)b,(c2,d)d)d,((h,p1)h,(p2,y)y)h)d;");
//		System.out.println(tournament);
//
//		// Tree of life
//		String s = readIntoString("inputs/itol.txt");
//		BinaryTree_Editted<String> itol = parseNewick(s);
