 ...
 * @author Tim Pierson, Dartmouth CS 10, Spring 2019; updated to use JSON instead of XML
 * 
...
public class FlickrSearchJSON extends JFrame {
	...
	private static String api_key = "809275a3e033d9823d5e17700e81be21";
	...
	private void loadImages(String query) throws Exception {
		...
		"photos": {
			...
			"perpage": 10,
			"total": "2667876",
			"photo": [{"id": "5340131446","owner": "58130019@N08","secret": "3b7c380bea","server": "5244","farm": 6,	"title": "dog","ispublic": 1,"isfriend": 0,"isfamily": 0},
					  {"id": "5338762379","owner": "58130019@N08","secret": "59f7435b93","server": "5284","farm": 6,	"title": "Dog","ispublic": 1,"isfriend": 0,"isfamily": 0	},
						...
						...
					]
		},
		...
		*/
		...
		//parse string as JSON and get photos
        ...
        try {
            ...
            JSONArray photosArray = (JSONArray) photosJsonObject.get("photo"); //now we have an array of information about photos
            
            //loop over each photo in photo array
            Iterator<JSONObject> iterator = photosArray.iterator();
            while (iterator.hasNext()) {
                //get photo details
                JSONObject photoDetails = iterator.next();
	            try {
	    				// Build the image URL as specified in the Flickr API
	    				String url = "http://farm" + photoDetails.get("farm") + ".staticflickr.com/" + 
