 ...
 */
public class DotTreeGUI_rough extends DrawingGUI {
    ...
    private List<Dot> dots; 						 // list for dots
        ...
        if (mode == 'a') {
            ...
            if (dots.size() == 0) {
                ...
                for (int m = 0; m < dots.size(); m++) {
                    tree.insert(dots.get(m));
                    System.out.println("kww" + dots.get(m));
